...
import operation.client.model.ErrorCode;
...
public class ReportGenerator2 {
    ...
    private static final String FILE_NAME = "Operation-report-";
    ...
    private void logResults(Map<Boolean, Long> results) {
        log.info("Generated temporary full report: {}. Added {} batches successfully, failed for {} batches. ",
                path,
