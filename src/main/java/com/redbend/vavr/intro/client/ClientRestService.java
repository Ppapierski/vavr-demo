...
import com.redbend.vavr.intro.client.validation.ClientFraudValidator;
import com.redbend.vavr.intro.client.validation.ClientValidator;
...
import static com.redbend.vavr.intro.generic.validations.Validator.validating;
...
public class ClientRestService implements Service {

    private static final JsonBuilderFactory JSON = Json.createBuilderFactory(Collections.emptyMap());

    private static final Logger LOGGER = Logger.getLogger(ClientRestService.class.getName());
