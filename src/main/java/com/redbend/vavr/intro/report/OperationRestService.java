...
import com.redbend.vavr.intro.report.generate.ReportGenerator;
...
public class OperationRestService implements Service {

    private static final JsonBuilderFactory JSON = Json.createBuilderFactory(Collections.emptyMap());

    private static final Logger LOGGER = Logger.getLogger(OperationRestService.class.getName());
